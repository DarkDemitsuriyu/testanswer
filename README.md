...
Ответ: Не сработает фрагмент 1. Так как инициализация функции происходит с использованием let и становится видна, только после ее объявления.
...
```  
Ответ: Возможно имеет смысл сделать так:
```
	<template>
		<component-name
			v-for="i of count" 
